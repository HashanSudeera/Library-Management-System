...
<div class="custom-sidebar bg-body-tertiary d-flex flex-column border-end">
    <ul class="nav flex-column mb-auto mt-1 pe-1">
        ...
        <li class="nav-item mb-1">
            <a href="dashboard.php" class="nav-link custom-nav-link d-flex align-items-center gap-3 py-2 px-4 <?php echo ($current_page == 'dashboard.php') ? 'active-tab' : ''; ?>">
        ...
        <li class="nav-item mb-1">
            <a href="borrowing.php" class="nav-link custom-nav-link d-flex align-items-center gap-3 py-2 px-4 <?php echo ($current_page == 'borrowing.php') ? 'active-tab' : ''; ?>">
